-- Snowflake schema: shared sub-dimensions (normalized hierarchies)
...
-- Pet dimension -> pet category (snowflake branch)
...
-- Customer -> country + pet (snowflake)
...
-- Product -> product category (snowflake)
